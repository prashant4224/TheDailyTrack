...
class ObjectivesControllerTest < ActionController::TestCase
  ...
  test "should create objective" do
    assert_difference('Objective.count') do
      post :create, objective: { description: @objective.description, end_date: @objective.end_date, name: @objective.name, phase_id: @objective.phase_id, start_date: @objective.start_date, type: @objective.type }
    end
  ...
  test "should update objective" do
    patch :update, id: @objective, objective: { description: @objective.description, end_date: @objective.end_date, name: @objective.name, phase_id: @objective.phase_id, start_date: @objective.start_date, type: @objective.type }
    assert_redirected_to objective_path(assigns(:objective))
  end
