...
class PhasesControllerTest < ActionController::TestCase
  ...
  test "should create phase" do
    assert_difference('Phase.count') do
      post :create, phase: { description: @phase.description, end_date: @phase.end_date, name: @phase.name, plan_id: @phase.plan_id, start_date: @phase.start_date }
    end
  ...
  test "should update phase" do
    patch :update, id: @phase, phase: { description: @phase.description, end_date: @phase.end_date, name: @phase.name, plan_id: @phase.plan_id, start_date: @phase.start_date }
    assert_redirected_to phase_path(assigns(:phase))
  end
